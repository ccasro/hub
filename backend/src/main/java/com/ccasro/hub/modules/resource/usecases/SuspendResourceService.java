...
public class SuspendResourceService {

  private final ResourceRepositoryPort resourceRepository;
  private final CurrentUserProvider currentUser;
  private final VenueAccessPolicy venuePolicy;
  ...
  public void execute(ResourceId resourceId) {
    ...
    venuePolicy.assertOwner(resource.getVenueId().value(), currentUser.getUserId());

    resource.suspend(clock);
