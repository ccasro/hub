...
export function DashboardClient({user, venues, bookings}: Props) {
    ...
    const totalCourts = activeVenues.reduce((sum, v) => sum + (v.resourceCount ?? 0), 0)
                        ...
                        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                            <div>
                                <div className="flex items-center gap-2">
                                    <Badge variant="secondary"
                                        ...
                                        {user.preferredSport ?? "Deportista"}
                                    </Badge>
                                    <Badge variant="secondary"
                            ...
                            <div className="flex shrink-0 items-center gap-3">
                                <Link href="/my/bookings">
                                    <Button variant="outline" className="gap-2 border-border/60 bg-secondary/30">
                        ...
                        <div className="lg:sticky lg:top-[calc(4rem+1.5rem)]">
                            ...
                            <div className="mt-4 rounded-xl border border-dashed border-primary/20 bg-primary/5 p-5">
                                ...
                                <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
                                    Encuentra companeros de juego de tu nivel en tu zona. Matching inteligente
                                    proximamente.
                                </p>
                                <Button variant="ghost" size="sm"
                                        className="mt-3 gap-1.5 px-0 text-xs text-primary hover:bg-transparent"
                                        disabled>
                                    Proximamente
