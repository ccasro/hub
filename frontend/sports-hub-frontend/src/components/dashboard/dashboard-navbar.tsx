...
export function DashboardNavbar({
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
                ...
                <div className="hidden flex-1 items-center gap-3 md:flex">
                    <div className="flex items-center gap-2 rounded-lg border border-border/50 bg-secondary/30 px-3">
                        ...
                        <Select value={selectedCity} onValueChange={onCityChange}>
                            <SelectTrigger
                                className="h-9 w-[140px] border-0 bg-transparent px-0 text-sm text-foreground shadow-none focus:ring-0">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <Link href="/dashboard/bookings" className="hidden md:block">
                        ...
                        >
                            ...
                            {upcomingBookingsCount > 0 && (
                                <Badge
                                    className="h-5 min-w-5 justify-center rounded-full border-0 bg-primary px-1.5 text-[10px] font-bold text-primary-foreground">
                            ...
                            <DropdownMenuGroup>
                                <DropdownMenuItem asChild>
                                    ...
                                    >
                                        ...
                                        {upcomingBookingsCount > 0 && (
                                            <Badge
                                                className="ml-auto h-5 min-w-5 justify-center rounded-full border-0 bg-primary px-1.5 text-[10px] font-bold text-primary-foreground">
                                                {upcomingBookingsCount}
                                            </Badge>
                                        )}
                                    </Link>
            ...
            {mobileMenuOpen && (
                <div
                    className="flex flex-col gap-3 border-t border-border/50 bg-background/95 px-4 py-3 backdrop-blur-xl md:hidden">
                ...
                Mis Reservas
                    ...
                    <div className="flex items-center gap-2 rounded-lg border border-border/50 bg-secondary/30 px-3">
                        ...
                        <Select value={selectedCity} onValueChange={onCityChange}>
                            <SelectTrigger
                                className="h-9 border-0 bg-transparent px-0 text-sm text-foreground shadow-none focus:ring-0">
                                <SelectValue placeholder="Ciudad"/>
                            </SelectTrigger>
                            <SelectContent className="border-border bg-card text-card-foreground">
                                {availableCities.map((city) => (
