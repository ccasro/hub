...
// Tipos "compatibles" con cualquier versión común de Recharts
type TooltipItem = {
...
type ChartTooltipContentProps = React.ComponentProps<'div'> & {
  ...
  // API típica de Recharts para contenido custom
  formatter?: (
      value: number | string,
      name: string | number,
      item: TooltipItem,
  ...
  labelFormatter?: (label: unknown, payload: TooltipItem[] | undefined) => React.ReactNode
                ...
                >
                  {formatter && item.value !== undefined && item.name != null ? (
                      formatter(
                          ...
                          item,
                          index,
                          item.payload as TooltipItem['payload'],
                      )
                  ) : (
                      <>
                        {itemConfig?.icon ? (
...
function ChartLegendContent({
  ...
  return (
      ...
      >
        {payload.map((item: LegendItem, idx: number) => {
